...
public class LanternProxy {
	...
	private static final Logger logger = LoggerFactory.getLogger(LanternProxy.class);
	...
	public Object aroundMethod(ProceedingJoinPoint pjp) throws Throwable {
		...
		logger.info("------------------------------before excute method,method name is:'" + o.getClass().getName() + "."
